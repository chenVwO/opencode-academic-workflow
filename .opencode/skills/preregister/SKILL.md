...
- `.opencode/skills/interview-me/SKILL.md` — produces the spec this skill consumes via `--input`.
- `.opencode/skills/verify-claims/SKILL.md` — Phase 5 invokes this for citation post-flight.
- `.opencode/instructions/discipline-cards.md` — field defaults that drive `--style` selection.
- `.opencode/instructions/replication-protocol.md` — preregistration is the *forward* commitment; replication-protocol is the *backward* contract.
