...
description: "Translate a Beamer `.tex` lecture to a Quarto RevealJS `.qmd` mirror. Multi-phase: TikZ extraction, slide-by-slide translation, citation conversion, automatic QA parity check. Output lands in `Quarto/`."
license: MIT
