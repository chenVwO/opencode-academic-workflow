...
$env:TEXINPUTS="../Preambles;$env:TEXINPUTS"; & xelatex -interaction=nonstopmode $ARGUMENTS.tex
$env:BIBINPUTS="..;$env:BIBINPUTS"; & bibtex $ARGUMENTS
$env:TEXINPUTS="../Preambles;$env:TEXINPUTS"; & xelatex -interaction=nonstopmode $ARGUMENTS.tex
$env:TEXINPUTS="../Preambles;$env:TEXINPUTS"; & xelatex -interaction=nonstopmode $ARGUMENTS.tex
```
...
```bash
Set-Location -Path Slides
$env:TEXINPUTS="../Preambles;$env:TEXINPUTS"; $env:BIBINPUTS="..;$env:BIBINPUTS"; latexmk -xelatex -interaction=nonstopmode $ARGUMENTS.tex
```
...
3. **Open the PDF** for visual verification:
   ```bash
   Start-Process "Slides\$ARGUMENTS.pdf"          # macOS
   # Start-Process "Slides\$ARGUMENTS.pdf"        # Linux (Start-Process works cross-platform)
   ```
