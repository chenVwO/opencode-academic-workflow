...
Fact-check a draft using the **Post-Flight Verification protocol** ([`.opencode/instructions/post-flight-verification.md`](../../rules/post-flight-verification.md)).
...
- `claim-verifier` agent file exists at `.opencode/agents/claim-verifier.md`
...
- [`.opencode/agents/claim-verifier.md`](../../agents/claim-verifier.md) — the forked verifier.
- [`.opencode/instructions/post-flight-verification.md`](../../rules/post-flight-verification.md) — the protocol.
