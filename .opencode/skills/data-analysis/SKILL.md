...
- **Follow R code conventions** in `.opencode/instructions/r-code-conventions.md`
...
- **Use project theme** for all figures (check for custom theme in `.opencode/instructions/`)
...
- `.opencode/instructions/r-code-conventions.md` — [one-line summary of most relevant rule]
- `.opencode/instructions/content-invariants.md` — [INV-9, INV-10, INV-11, INV-12 applicable]
