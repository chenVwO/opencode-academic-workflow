...
Compare numeric claims in a manuscript (point estimates, standard errors, p-values, counts) against the actual outputs produced by the analysis pipeline. Report PASS / FAIL per claim against the tolerance thresholds defined in [`.opencode/instructions/replication-protocol.md`](../../rules/replication-protocol.md).
...
**Tolerance source:** .opencode/instructions/replication-protocol.md
...
- [`.opencode/instructions/replication-protocol.md`](../../rules/replication-protocol.md) — the tolerance contract.
- [`.opencode/skills/review-r/SKILL.md`](../review-r/SKILL.md) — catches code-style issues; this skill catches NUMERICAL reproducibility.
- [`.opencode/skills/review-paper/SKILL.md`](../review-paper/SKILL.md) — content review; pair with this skill for a full pre-submission audit.
