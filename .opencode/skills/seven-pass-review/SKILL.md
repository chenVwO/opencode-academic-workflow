...
- `.opencode/skills/review-paper/SKILL.md` — the single-pass and `--adversarial` modes (cheaper, faster).
- `.opencode/skills/validate-bib/SKILL.md` — invoked by Lens 7.
- `.opencode/skills/audit-reproducibility/SKILL.md` — complementary; numeric-claims side of the audit.
