<!-- Original: tikz-prevention.md — path-scoped (Slides/**/*.tex, Figures/**/*.tex, Preambles/**/*.tex) — TikZ collision prevention -->
...
- Quality scoring is defined in [`.opencode/instructions/quality-gates.md`](quality-gates.md). The TikZ section there deducts −5 for a label-overlap finding (which is typically the symptom of a P1/P3/P4 violation that reached production); it does **not** currently deduct per-rule. That may change — consult `quality-gates.md` for the authoritative scoring rubric.
