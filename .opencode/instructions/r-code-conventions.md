<!-- Original: r-code-conventions.md — path-scoped (**/*.R, Figures/**/*.R, scripts/**/*.R) — R code standards -->
...
See [`.opencode/agents/r-reviewer.md`](../agents/r-reviewer.md) Category 11 ("Numerical Discipline") for the full checklist. Headline rules:
