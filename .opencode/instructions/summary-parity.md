<!-- Original: summary-parity.md — anti–whack-a-mole rule for summary-body drift -->
...
- `.opencode/skills/commit/SKILL.md` — when writing the commit message for a doc-heavy PR, apply this rule to the `## Summary` section before pushing.
