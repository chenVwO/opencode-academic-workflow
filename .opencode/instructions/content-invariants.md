<!-- Original: content-invariants.md — path-scoped (Slides/**/*.tex, Quarto/**/*.qmd, Quarto/**/*.scss, Preambles/header.tex, scripts/R/**/*.R) — numbered non-negotiable content invariants -->
...
- **INV-6: No `\pause` or overlays.** Beamer `\pause`, `\only`, `\visible`, `\onslide` commands are forbidden. See `.opencode/instructions/no-pause-beamer.md` for rationale.
