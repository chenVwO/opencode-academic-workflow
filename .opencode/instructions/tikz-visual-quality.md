<!-- Original: tikz-visual-quality.md — path-scoped (Slides/**/*.tex, Figures/**/*.tex) — TikZ visual polish standards -->
...
- Standard scale: `[scale=1.1, every node/.style={scale=1.1}]` for full-width diagrams — always scale nodes together with coordinates (bare `[scale=X]` is banned by [`.opencode/instructions/tikz-prevention.md` P3](tikz-prevention.md) because it shrinks coordinates but not text)
