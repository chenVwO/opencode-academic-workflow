<!-- Original: beamer-quarto-sync.md — path-scoped (Slides/**/*.tex, Quarto/**/*.qmd) — mandatory Beamer ↔ Quarto sync rule -->
...
This rule (auto-sync) and [`.opencode/instructions/single-source-of-truth.md`](single-source-of-truth.md) (Beamer is authoritative) can conflict after a human has hand-edited the Quarto file. Resolution:
