<!-- Original: cross-artifact-review.md — paper ↔ code cross-artifact review protocol -->
...
- `.opencode/skills/review-paper/SKILL.md` — the orchestrator.
- `.opencode/skills/review-r/SKILL.md` — code reviewer.
- `.opencode/skills/audit-reproducibility/SKILL.md` — numeric claims verifier.
- `.opencode/instructions/replication-protocol.md` — tolerance contract.
