...
2. **Read `.opencode/instructions/r-code-conventions.md`** for the current standards
...
- [ ] Check `.opencode/instructions/r-code-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `.opencode/instructions/r-code-conventions.md` for project-specific bugs.
